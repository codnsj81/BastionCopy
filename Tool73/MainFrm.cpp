...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_SecondSplitter.CreateView(0, 0,
								RUNTIME_CLASS(CMiniView), 
								CSize(200, 200), pContext);

	m_SecondSplitter.CreateView(1, 0,
								RUNTIME_CLASS(CMyForm), 
								CSize(200, 200), pContext);

	m_MainSplitter.SetColumnInfo(0, 200, 50);

	m_pMainView = (CTool73View*)m_MainSplitter.GetPane(0, 1);
